...
public class HueProximityFuzzyBinaryConstraint implements GraphConstraint<ColourPointLCH> {

  private Integer c1Id;
  private Integer c2Id;
  private double Lthreshold;

  public HueProximityFuzzyBinaryConstraint(ColourPointLCH _p1, ColourPointLCH _p2, double _Lthreshold) {
    this.c1Id = _p1.getId();
    this.c2Id = _p2.getId();
  ...
  public double evaluate(ColourPointLCH... c) {
    ...
    double d = Math.abs(lchA[2]-lchB[2]);
